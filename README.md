...
Predicting heart disease risk with a focus on minimizing false negatives. Implements advanced handling of class imbalance to build diagnostic tool.
...
Therefore, this project prioritises Recall (Sensitivity) over Accuracy to minimise False Negatives (missed diagnoses), the most critical factor in medical screening.
...
## Workflow and comparative results
